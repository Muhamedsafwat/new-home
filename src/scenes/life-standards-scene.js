...
export class LifeStandardsScene extends Phaser.Scene {
  ...
  constructor() {
    ...
    this.#textArray = [
      ...
      "المناخ المستقر و درجات الحرارة المعتدلة ضرورية للحياة. التذبذب الكبير في درجات الحرارة بين الليل والنهار أو بين الفصول قد يجعل الحياة صعبة أو مستحيلة.",
      " في حالة الكوكب المقيد مداريًا (حيث يواجه جانب واحد النجم دائمًا)، سيعاني الكوكب من مشكلتين: الجانب النهاري سيصبح شديد الحرارة، بينما الجانب الليلي سيكون باردًا جدًا. هذا التفاوت يجعل السكن صعبًا إلا في المناطق القريبة من الحد الفاصل بين الليل والنهار. كما يجب أن يكون الغلاف الجوي كثيفًا لينقل الحرارة بين الجانبين لتقليل هذا التفاوت"
    ];
  }
